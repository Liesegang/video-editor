...
pub use types::{
    ...
    NUMERIC_B_INPUT_PORT, PortAddress, PortDataType, PortDefinition, PortDirection, PortExposure,
    PortMultiplicity, PortOwner, PortSide, ProjectConnection, RESOLUTION_PORT, SHAPE_INPUT_PORT,
    SHAPE_OUTPUT_PORT, SOUND_INPUT_PORT, SPECTRUM_INPUT_PORT, SPECTRUM_OUTPUT_PORT, TIME_PORT,
};
