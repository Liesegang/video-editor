...
use crate::runtime::frame::{FrameInfo, Region};
...
mod tests {
    ...
    use crate::project::property::{Property, PropertyMap, PropertyValue, Vec2};
    use crate::project::track::TrackData;
    use crate::runtime::color::Color;
    use crate::runtime::entity::FrameContent;
    ...
    fn create_test_plugin_manager() -> Arc<PluginManager> {
        ...
        manager.register_entity_converter_plugin(Arc::new(
            crate::builtin::entity_converter::VideoEntityConverterPlugin::new(),
        ));
        manager.register_entity_converter_plugin(Arc::new(
            crate::builtin::entity_converter::ImageEntityConverterPlugin::new(),
        ));
        manager.register_entity_converter_plugin(Arc::new(
            crate::builtin::entity_converter::TextEntityConverterPlugin::new(),
        ));
        manager.register_entity_converter_plugin(Arc::new(
            crate::builtin::entity_converter::ShapeEntityConverterPlugin::new(),
        ));
        manager.register_entity_converter_plugin(Arc::new(
            crate::builtin::entity_converter::SkSLEntityConverterPlugin::new(),
        ));
        manager
    }
