...
use crate::core::model::TrackClip;
use crate::core::model::project::Composition;
use crate::core::model::property::{PropertyMap, PropertyValue};
use crate::core::model::style::StyleInstance;
use crate::extensions::traits::Plugin;
use crate::extensions::traits::EvaluationContext; use crate::extensions::manager::PropertyEvaluatorRegistry;
...
pub trait EntityConverterPlugin: Plugin {
    ...
    fn plugin_type(&self) -> crate::extensions::traits::PluginCategory {
        crate::extensions::traits::PluginCategory::EntityConverter
    }
}
        ...
        instances
            ...
            .filter_map(|instance| {
                ...
                let color = match color_val {
                    ...
                    _ => crate::core::frame::color::Color { r: 0, g: 0, b: 0, a: 255 }, // Default Black? Or White?
                };
...
impl EntityConverter for TextEntityConverter {
    ...
    fn get_bounds(
        ...
        let width =
            crate::graphics::text_layout::measure_text_width(&text, &font_name, size as f32);
...
impl crate::extensions::traits::Plugin for BuiltinEntityConverterPlugin {
