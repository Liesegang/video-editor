...
use crate::core::frame::entity::FrameObject;
use crate::core::frame::frame::FrameInfo;
use crate::core::model::project::{Composition, Project};
use crate::core::model::{TrackClip, TrackClipKind}; // Add explicit import
use crate::util::timing::ScopedTimer;

use super::converter::{EntityConverterRegistry, FrameEvaluationContext};
use crate::extensions::manager::PropertyEvaluatorRegistry;
...
mod tests {
    use super::*;
    use crate::core::frame::color::Color; // Added
    use crate::core::frame::entity::FrameContent; // Added
    use crate::core::model::project::Composition; // Added
    use crate::core::model::property::{Property, PropertyMap, PropertyValue, Vec2};
    use crate::core::model::{Track, TrackClip, TrackClipKind}; // import kind

    use crate::extensions::manager::PluginManager;
    use crate::extensions::properties::{
    ...
    fn create_test_plugin_manager() -> Arc<PluginManager> {
        ...
        manager.register_entity_converter_plugin(Arc::new(
            crate::timeline::converter::BuiltinEntityConverterPlugin::new(),
        )); // Added
        manager
    }
