...
impl EffectPlugin for DropShadowEffectPlugin {
    fn apply(
        ...
        let color_val = params
            .get("color")
            .and_then(|pv| pv.get_as::<crate::core::frame::color::Color>())
            .unwrap_or(crate::core::frame::color::Color {
                r: 0,
                g: 0,
                b: 0,
                a: 255,
    ...
    fn properties(&self) -> Vec<crate::extensions::traits::PropertyDefinition> {
        ...
        vec![
            ...
            PropertyDefinition {
                ...
                default_value: PropertyValue::Color(crate::core::frame::color::Color {
                    r: 0,
                    g: 0,
                    b: 0,
                    a: 255,
