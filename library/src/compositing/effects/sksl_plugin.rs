...
use crate::extensions::traits::{EffectPlugin, Plugin, PropertyDefinition, PropertyUiType};
            ...
            .map(|p| {
                ...
                let default_value = match &p.default {
                    ...
                    Some(ValueWrapper::Vec2(v)) => {
                        PropertyValue::Vec2(crate::core::model::property::Vec2 {
                            x: OrderedFloat(v[0]),
                            y: OrderedFloat(v[1]),
                        })
                    }
                    Some(ValueWrapper::Vec3(v)) => {
                        PropertyValue::Vec3(crate::core::model::property::Vec3 {
                            x: OrderedFloat(v[0]),
                            y: OrderedFloat(v[1]),
                            z: OrderedFloat(v[2]),
                        })
                    ...
                    Some(ValueWrapper::Vec4(v)) => {
                        PropertyValue::Vec4(crate::core::model::property::Vec4 {
                            x: OrderedFloat(v[0]),
                            y: OrderedFloat(v[1]),
                            z: OrderedFloat(v[2]),
                            w: OrderedFloat(v[3]),
