...
use crate::timeline::converter::EntityConverterRegistry;
use crate::timeline::evaluator::get_frame_from_project;
use crate::io::image::Image;
use crate::core::frame::entity::{FrameContent, FrameObject}; // FrameEntity -> FrameContent
use crate::core::frame::frame::FrameInfo;
use crate::core::frame::transform::Transform;
use crate::extensions::traits::{LoadRequest, LoadResponse}; use crate::extensions::manager::PluginManager;
use crate::graphics::renderer::{RenderOutput, Renderer};
...
impl<T: Renderer> RenderService<T> {
    ...
    pub fn render_frame(
        ...
        time: f64,
    ) -> Result<crate::graphics::renderer::RenderOutput, LibraryError> {
    ...
    fn apply_effects(
        &mut self,
        layer: RenderOutput,
        effects: &[crate::core::frame::effect::ImageEffect],
        _current_time: f64,
