use crate::compositing::audio::engine::AudioEngine;
...
use crate::app::audio_service::AudioService;
...
impl EditorService {
    ...
    pub fn set_project(&self, project: crate::core::model::project::Project) {
