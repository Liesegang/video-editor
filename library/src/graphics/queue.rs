...
use crate::app::project_model::ProjectModel; use crate::compositing::render_service::RenderService;
...
use crate::graphics::skia_renderer::SkiaRenderer;
...
impl RenderQueue {
    ...
    fn spawn_workers(
        ...
        surface_width: u32,
        surface_height: u32,
        background_color: crate::core::frame::color::Color,
        _export_format: ExportFormat,
        export_settings: Arc<ExportSettings>,
            ...
            let handle = thread::spawn(move || {
                ...
                loop {
                    ...
                    let image = match render_result {
                        Ok(crate::graphics::renderer::RenderOutput::Image(img)) => img,
                        Ok(output @ crate::graphics::renderer::RenderOutput::Texture(_)) => {
