...
use crate::core::frame::draw_type::{CapType, DrawStyle, JoinType, PathEffect};
use crate::core::frame::entity::StyleConfig;
use crate::core::frame::transform::Transform;
use crate::graphics::renderer::{RenderOutput, Renderer, TextureInfo};
use crate::graphics::shader_utils::{self, ShaderContext};
use crate::graphics::skia_utils::{
...
impl Renderer for SkiaRenderer {
    ...
    fn get_gpu_context(&mut self) -> Option<&mut crate::graphics::skia_utils::GpuContext> {
