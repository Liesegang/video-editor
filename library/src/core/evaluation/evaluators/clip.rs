...
use crate::core::evaluation::text_decompose;
...
use crate::plugin::loaders::LoadRequest;
...
impl ClipEvaluator {
    ...
    fn text_shape(
        &self,
        clip: &crate::model::project::clip::TrackClip,
        ctx: &mut EvalContext,
    ) -> Result<PinValue, LibraryError> {
    ...
    fn evaluate_image(
        &self,
        properties: &crate::model::project::property::PropertyMap,
        ctx: &mut EvalContext,
    ) -> Result<PinValue, LibraryError> {
