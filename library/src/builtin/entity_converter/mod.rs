...
use crate::project::effect::EffectConfig;
use crate::project::project::Composition;
use crate::project::property::{PropertyMap, PropertyValue, Vec2};
...
pub struct FrameEvaluationContext<'a> {
    ...
    pub project: &'a crate::project::project::Project,
}
...
impl<'a> FrameEvaluationContext<'a> {
    ...
    pub fn build_image_effects(
        ...
        time: f64,
    ) -> Vec<crate::runtime::effect::ImageEffect> {
        use crate::runtime::effect::ImageEffect;
        effects
            .iter()
            .map(|e| {
    ...
    pub fn build_clip_effects(
        ...
        use crate::project::graph_analysis;
        use crate::runtime::effect::ImageEffect;
    ...
    pub fn build_styles_from_graph(
        ...
        clip_id: uuid::Uuid,
        time: f64,
    ) -> Vec<crate::runtime::entity::StyleConfig> {
        use crate::project::graph_analysis;
        ...
        style_ids
            ...
            .filter_map(|&node_id| {
                ...
                if let Some(plugin) = self.plugin_manager.get_style_plugin(style_type) {
                    ...
                    let instance = crate::project::style::StyleInstance::new_with_id(
                        node_id,
                        style_type,
    ...
    pub fn build_effectors_from_graph(
        ...
        clip_id: uuid::Uuid,
        time: f64,
    ) -> Vec<crate::evaluation::ensemble::config::EffectorConfig> {
        use crate::project::graph_analysis;
        ...
        effector_ids
            ...
            .filter_map(|&node_id| {
                ...
                if let Some(plugin) = self.plugin_manager.get_effector_plugin(effector_type) {
                    let instance = crate::project::ensemble::EffectorInstance::new_with_id(
                        node_id,
                        effector_type,
                        graph_node.properties.clone(),
                    );
    ...
    pub fn build_decorators_from_graph(
        ...
        clip_id: uuid::Uuid,
        time: f64,
    ) -> Vec<crate::evaluation::ensemble::config::DecoratorConfig> {
        use crate::project::graph_analysis;
        ...
        decorator_ids
            ...
            .filter_map(|&node_id| {
                ...
                if let Some(plugin) = self.plugin_manager.get_decorator_plugin(decorator_type) {
                    let instance = crate::project::ensemble::DecoratorInstance::new_with_id(
                        node_id,
                        decorator_type,
                        graph_node.properties.clone(),
                    );
    ...
    pub fn parse_path_effects(
        ...
        _props: &PropertyMap,
        _time: f64,
    ) -> Vec<crate::runtime::draw_type::PathEffect> {
        Vec::new()
    }
    ...
    pub fn evaluate_cap_type(
        ...
        key: &str,
        time: f64,
        default: crate::runtime::draw_type::CapType,
    ) -> crate::runtime::draw_type::CapType {
        use crate::runtime::draw_type::CapType;
        if let Some(prop) = props.get(key) {
            let val = self.evaluate_property_value(prop, props, time);
            if let Some(s) = val.get_as::<String>() {
    ...
    pub fn evaluate_join_type(
        ...
        key: &str,
        time: f64,
        default: crate::runtime::draw_type::JoinType,
    ) -> crate::runtime::draw_type::JoinType {
        use crate::runtime::draw_type::JoinType;
        if let Some(prop) = props.get(key) {
            let val = self.evaluate_property_value(prop, props, time);
            if let Some(s) = val.get_as::<String>() {
                return match s.to_lowercase().as_str() {
