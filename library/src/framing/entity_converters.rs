...
impl EntityConverter for SkSLEntityConverter {
    ...
    fn get_bounds(
        ...
        let width =
            evaluator.evaluate_number(props, "width", eval_time, evaluator.composition.width as f64);
        let height =
            evaluator.evaluate_number(props, "height", eval_time, evaluator.composition.height as f64);
