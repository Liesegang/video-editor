...
impl ProjectManager {
    ...
    pub fn import_file(&self, path: &str) -> Result<Vec<Uuid>, LibraryError> {
        ...
        if let Some(streams) = self.plugin_manager.get_available_streams(path) {
            for stream in streams {
                ...
                let mut asset = crate::project::asset::Asset::new(&name, path, stream.kind);
        ...
        if assets_to_add.is_empty() {
            ...
            let (mut kind, duration, fps, width, height) =
                if let Some(meta) = self.plugin_manager.get_metadata(path) {
                    ...
                    (
                        crate::project::asset::AssetKind::Other,
                        None,
                        None,
                        None,
                        None,
            ...
            if kind == crate::project::asset::AssetKind::Other {
                ...
                kind = match ext.as_str() {
                    "mp4" | "mov" | "avi" | "mkv" | "webm" => {
                        crate::project::asset::AssetKind::Video
                    }
                    "png" | "jpg" | "jpeg" | "bmp" | "webp" => {
                        crate::project::asset::AssetKind::Image
                    }
                    "mp3" | "wav" | "ogg" | "aac" | "flac" => {
                        crate::project::asset::AssetKind::Audio
                    }
                    "obj" | "gltf" | "glb" => crate::project::asset::AssetKind::Model3D,
                    _ => crate::project::asset::AssetKind::Other,
                };
            }

            // 3. Create Asset
            let mut asset = crate::project::asset::Asset::new(&base_name, path, kind);
    ...
    pub fn add_graph_connection(
        &self,
        from: crate::project::connection::PinId,
        to: crate::project::connection::PinId,
    ) -> Result<crate::project::connection::Connection, LibraryError> {
