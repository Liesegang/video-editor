...
FULL_SUITES = (
    ...
    SuiteSpec(
        "point-position",
        "qa-point-position-e2e.py",
        project_file=True,
        expects_exit=True,
    ),
    SuiteSpec(
        "point-size",
        "qa-point-size-e2e.py",
        project_file=True,
        expects_exit=True,
    ),
    ...
    SuiteSpec("node-copy-paste", "qa-node-copy-paste-e2e.py",
              project_file=True, expects_exit=True),
    SuiteSpec("module-effect-automation", "qa-module-effect-automation-e2e.py",
              project_file=True, expects_exit=True),
