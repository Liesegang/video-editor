...
from qa_node_module_support import (
    active_definition as _shared_active_definition,
    component as _component,
    connection as _connection,
    place_node_for_inline_edit as _place_node_for_inline_edit,
    port as _port,
)
...
def _active_definition(state):
    return _shared_active_definition(state, "transition")
