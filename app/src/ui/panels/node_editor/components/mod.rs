...
pub(in crate::ui::panels::node_editor) use merge_layers::{
    ...
    merge_layer_rows, merge_vacant_slot, native_variadic_connection_visual_cmp,
    native_variadic_merge_for_node, native_variadic_merge_target, register_merge_layer_component,
    wire_order_menu_state, wire_order_menu_states, wire_order_qa_metadata,
};
#[cfg(test)]
pub(in crate::ui::panels::node_editor) use merge_layers::{
    WireOrderMenuState, merge_images_target_node_id,
};
