...
use crate::ui::panels::node_editor::{
    container_rect, set_container_geometry, translate_container, LayoutEdit, AUTO_LAYOUT_CLIP_TOP,
    AUTO_LAYOUT_COMPOSITION_BOTTOM, AUTO_LAYOUT_COMPOSITION_LEFT, AUTO_LAYOUT_COMPOSITION_RIGHT,
    AUTO_LAYOUT_COMPOSITION_TOP, AUTO_LAYOUT_NODE_PADDING, AUTO_LAYOUT_TRACK_BOTTOM,
