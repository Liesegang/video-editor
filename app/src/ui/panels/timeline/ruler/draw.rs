...
pub fn draw_ruler_marks(
    ...
    if is_frame_display_mode {
        ...
        let (major_interval_frames, minor_interval_frames, _) = ticks::get_frame_intervals(pixels_per_frame, composition_fps as f32);
        ...
        let last_visible_frame = ((scroll_offset_x + rect.width()) / pixels_per_frame).ceil() as i32;
        ...
        while current_frame <= last_visible_frame {
            ...
            if screen_x >= rect.min.x && screen_x <= rect.max.x {
                ...
                painter.line_segment(
                    [egui::pos2(screen_x, line_start_y), egui::pos2(screen_x, line_end_y)],
        ...
        for i in start_i..=end_i {
            ...
            if screen_x >= rect.min.x && screen_x <= rect.max.x {
                ...
                let is_major = if step_ratio > 0 { i % step_ratio == 0 } else { true };
