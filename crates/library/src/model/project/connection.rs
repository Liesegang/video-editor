...
pub use types::{
    ...
    SPECTRUM_INPUT_PORT, SPECTRUM_OUTPUT_PORT, TIME_PORT, TRANSITION_FROM_INPUT_PORT,
    TRANSITION_PROGRESS_INPUT_PORT, TRANSITION_PROGRESS_PROPERTY, TRANSITION_TO_INPUT_PORT,
};
