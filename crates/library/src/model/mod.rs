...
pub use node::{
    ...
    ColorContent, CompositionInstanceContent, DataContent, GeneratorContent,
    LEGACY_MEDIA_COLOR_PROPERTY_KEYS, LegacyMediaColorProperty, ListContent, MediaContent,
    MediaOutputSelection, ModuleOutputContent, NativeNodeCatalogDescriptor, NativeNodeFactory,
