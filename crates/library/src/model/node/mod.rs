...
pub(crate) use catalog::{
    ...
    SELECT_FALSE_INPUT_PORT, SELECT_TRUE_INPUT_PORT, SPRITE_COLLECTION_INPUT_PORT,
    SPRITE_COLOR_INPUT_PORT, SPRITE_SELECTION_INPUT_PORT, SPRITE_SELECTION_MODE_INPUT_PORT,
