...
#[cfg(all(feature = "gl", target_os = "windows"))]
use crate::rendering::renderer::PointRasterRequest;
...
mod point_size_gpu;
#[cfg(all(feature = "gl", target_os = "windows"))]
#[path = "tests/point_sprite_gpu.rs"]
mod point_sprite_gpu;
#[cfg(all(feature = "gl", target_os = "windows"))]
...
#[cfg(all(feature = "gl", target_os = "windows"))]
#[path = "tests/particle_scene.rs"]
mod particle_scene;
#[cfg(all(feature = "gl", target_os = "windows"))]
use particle_scene::{
    particle_parameters_mut, particle_scene, particle_vec3, render_point_test_scene,
    set_particle_step,
};
