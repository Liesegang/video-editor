...
use crate::plugin::{
    EFFECT_APPLY_OPERATION, EFFECT_CATEGORY, IMAGE_TRANSFORM_COMPONENT_ID, STYLE_APPLY_OPERATION,
    STYLE_CATEGORY, TRANSFORM_APPLY_OPERATION, TRANSFORM_CATEGORY, property_name_from_port,
};
...
use appearance::appearance_image;
use frame_values::{
