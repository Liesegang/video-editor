...
pub use timeline_editor_service::{
    ...
    EditProjection, GeneratorNodeClipPlacement, ModuleAttachmentPlacement, ModuleAutomationOwner,
    ModuleInputHost, ModuleInterfaceCommand, ModuleInterfaceEditImpact, ModuleInterfaceEditResult,
    ModuleItemPlacement, ModuleNodePresentationUpdate, ModuleParameterKeyframePublication,
    ModuleSelectionClipboard, ModuleSelectionPasteReceipt, NodeClipAppearanceEntry,
    NodeClipAppearanceStack, NodeClipConversionResult, NodeClipTextContent,
    NodeClipTextEnsembleEntry, NodeClipTextEnsembleStack, PreparedModuleDefinitionEdit,
    SharedModuleEdit, TimelineEditError, TimelineEditOperation, TimelineEditPlanningIndex,
    TimelineEditRequest, TimelineEditorService, TimelineItemDependency, TimelineItemEditState,
    TimelineSettingsUpdate, TransitionAutomationOwner, TransitionPlacement, plan_timeline_edit,
    project_edit_plan,
};
